...
def handler(event, context):
    ...
    try:
        ...
        max_files_allowed_str = user_attributes.get("custom:max_files_allowed", "999999")
        max_pages_allowed_str = user_attributes.get("custom:max_pages_allowed", "10000")
        max_size_allowed_mb_str = user_attributes.get("custom:max_size_allowed_MB", "5120")
        ...
        try:
            ...
            max_files_allowed = 999999  # Default: unlimited

        try:
            max_pages_allowed = int(max_pages_allowed_str)
        except ValueError:
            max_pages_allowed = 10000  # Default: 10000 pages

        try:
            max_size_allowed_mb = int(max_size_allowed_mb_str)
        except ValueError:
            max_size_allowed_mb = 5120  # Default: 5GB
